...
*
* This file implements the serial protocol from the Baron Online Transcript
*/

#ifndef STENOSAURUS_TXBOLT_H
#define STENOSAURUS_TXBOLT_H
...
#endif // #ifndef STENOSAURUS_TXBOLT_H
